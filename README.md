...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [tablo](https://docs.google.com/spreadsheets/d/1wdwCmuY7rzQXTPvAvihc8O-FvuzyG5s126ik8Q_uzN4/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 
...
a) Denkleminizi **6,69E-03 + 1,78x + -1,19x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif?

**Cevap:** a=ivme,b=ilk hız,c=ilk konum ve Bu örnekte cisim yavaşladığı için a negatif.
...
**Cevap:** B yani ilk hız değişirdi. A ve C yani ivme ve ilk konum sabit kalırdı.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1pDo3xEsLVMcvbdl9XXkLhpXAjxPtmuZJZk4r6J1TPnU/edit#gid=0) link veriniz.
...
**cevap:** -0,1933649181,Kk=0.06333333076
...
**Cevap** Bence hayır. Çünkü çünkü cisim sabit ivmeli değil ve atıldığı an videoda yok.
